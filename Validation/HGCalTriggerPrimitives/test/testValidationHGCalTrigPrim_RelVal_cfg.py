...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('validationHGCalTPG.root')
)
...
process.schedule = cms.Schedule(process.hgcl1tpg_step, process.hgcalValidationTPG_step, process.ntuple_step, process.dqmsave_step)
